<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sales-report.aspx.cs" Inherits="Stride.sales_report" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
						...
						<div class="row">
						<div class="col-md-2">
						<h3 class="box-title m-b-0">Sales Report</h3>
						</div>
						<div class="col-md-2">
						...
						<div class="col-md-1">
						<button class="btn btn-primary" onclick="getSalesReportByPatientId(); return false;">Ok</button>
						</div>
						</div>
                            <input type="hidden" id="patientCode" value="" />
                            <hr>
                           <div class="table-responsive">
                                <table id="salesreporttable" class="display nowrap" >
                                    <thead>
                                        <tr>
                                            <th>Bill No</th>
                                            <th>Bill Date</th>
                            ...
                            <br /><br /><br /><br />
                            <div class="text-right"><h3><b>Total Amount : <span id="totalsaleamount"></span></b></h3></div>
                        </div>
