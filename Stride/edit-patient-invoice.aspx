<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="edit-patient-invoice.aspx.cs" Inherits="Stride.edit_patient_invoice" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive m-t-40">
                                        ...
                                        <input type="hidden" id="transcationId" value="" />
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        ...
                                        <p>Sub - Total amount:  <i class="fa fa-inr"></i><input type="hidden" id="subtotalvalue" /><span id="subtotal">0</span></p>
                                        <p>GST  :  <i class="fa fa-inr"></i><input type="hidden" id="gstvalue" /><span id="totalgst">0</span> </p>
                                        <hr>
                                        <h3><b>Total :</b> <i class="fa fa-inr"></i> <input type="hidden" id="totalvalue" /><span id="totalamount">0</span></h3> </div>
                                    ...
                                    <div class="col-lg-10 col-md-8 col-sm-12">
                                        ...
                                        <button onClick="PrintInvoice('editinvoice');" class="btn btn-default btn-outline btn-sm printInvoiceRight" type="button"> <span><i class="fa fa-print"></i> Print / Save</span> </button>
										<button class="btn btn-primary btn-sm printInvoiceRight" onclick="SendInvoiceMail('editinvoice')" ><i class="fa fa-envelope-o"></i> Send Mail / Save</button>
                                         <button  class="btn btn-primary btn-sm addInvoiceRight" onclick="proceedToPayment('editinvoice')" ><i class="fa fa-inr"></i> Proceed to payment / Save</button>
									</div>
                                     <div class="col-lg-2 col-md-4 col-sm-12">
                                       
                                         <button  class="btn btn-primary btn-sm addInvoiceRight" onclick="updateInvoiceBill('editinvoice')" ><i class="fa fa-inr"></i> Save Invoice</button>
									</div>
                                </div>
                            </div>
                        </div>
    ...
    var loadcontact = {
        ...
        select: function (event, ui) {
            ...
            var servicedata = [ui.item.id, ui.item.label];
             ...
             for (var k = 1; k <= pos; k++)
             {
                 if ($('#editserviceCode' + k).val() == ui.item.id)
                 {
                     $.toast({
             ...
             $('#patientInvoiceTable tbody').append('<tr id="rowId' + ++pos + '">' +
                 ...
                 '<td class="text-center" ><span id="invoiceServiceId' + pos + '"> ' + pos + ' </span><input type="hidden" id="serviceCode' + pos + '" value="' + ui.item.id + '"></td >' +
