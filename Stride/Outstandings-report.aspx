<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Outstandings-report.aspx.cs" Inherits="Stride.Outstandings_report" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
						...
						<div class="row">
						<div class="col-md-4">
						<h3 class="box-title m-b-0">Outstanding Report</h3>
						</div>
						...
						<div class="col-md-4">
						<button class="btn btn-primary" onclick="getOutstandingReportByPatienId(); return false;">Ok</button>
						</div>
						</div>
                            <input type="hidden" id="patientCode" value="" />
                            <hr>
                           <div class="table-responsive">
                                <table id="outstandingreporttable" class="display nowrap" >
                                    <thead>
                                        <tr>
                                            <th>Patient Code</th>
                                            <th>Patient Name</th>
                             ...
                             <br /><br /><br /><br />
                            <div class="text-right"><h3><b>Total Amount : <span id="totaloutstandingamount"></span></b></h3></div>
                        </div>
                    </div>
                </div>
                <!-- .row -->
