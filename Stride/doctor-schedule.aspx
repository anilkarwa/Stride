<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="doctor-schedule.aspx.cs" Inherits="Stride.doctor_schedule" %>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">My Schedule</h4> </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="white-box">
                            <h3 class="box-title">Drag and drop your Appointment to calender</h3>
                            <div class="row">
                ...
                <!-- /.row -->
                <!-- BEGIN MODAL -->
                <div class="modal fade none-border" id="my-event" style="padding-top:10%;">
